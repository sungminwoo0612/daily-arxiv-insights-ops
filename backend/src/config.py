...
# 현재 파일 위치: backend/src/config.py
...
class Settings:
    ...
    RERANKER_STRATEGY: str = os.getenv("RERANKER_STRATEGY", "hybrid")  # "cohere", "bge", "hybrid", "cascade", "none"
    BGE_DEVICE: str = os.getenv("BGE_DEVICE", "cpu")  # "cuda" 또는 "cpu"
    ...
    def validate(cls) -> None:
        ...
        # Cohere 전략 사용 시 API 키 검증
        if cls.RERANKER_STRATEGY.lower() in ["cohere", "hybrid", "cascade"]:
